...
for row in cur.fetchall() :
    y1.append(row[7])
    x1.append(round(row[2],0))

fig = plt.figure()
ax = plt.subplot(1,1,1)

plt.title('Velocidade de cauda')

windshear1 = ax.plot(x1, y1)  # plot x and y using blue circle markers
...
fig.savefig(diretorio_graficos+'vel_cauda_27.png', bbox_inches='tight')
