...
##cur.execute("SELECT * FROM sodar_ncqar order by id desc limit 2450")
...
x = 49 ## Número de observações com intervalo de 15 minutos para 3 horas 
a = 50 ## Número de alturas , indo de 30 a 520 temos 50 alturas
y = 49 ## Numero de observacoes com intervalo de 15 minutos para 3 horas 
...
fig.savefig(diretorio_graficos+'barbela12h.png', bbox_inches='tight')
