...
##cur.execute("SELECT * FROM sodar_ncqar order by id desc limit 4850")
...
x = 97 ## Número de observações com intervalo de 15 minutos para 3 horas 
a = 50 ## Número de alturas , indo de 30 a 520 temos 50 alturas
y = 97 ## Numero de observacoes com intervalo de 15 minutos para 3 horas 
...
fig.savefig(diretorio_graficos+'barbela24h.png', bbox_inches='tight')
